...
**Status:** v0.0.3 walking skeleton. Half of v0.1 works: SSH connect, SFTP browse, markdown viewer. Edit/save and SQLite are next. See [ROADMAP.md](docs/ROADMAP.md) for what's coming.
