...
**Status:** v0.0.4 walking skeleton. SSH **and local** browsing both work; markdown viewer renders inline. Edit/save and SQLite are next. See [ROADMAP.md](docs/ROADMAP.md) for what's coming.
